...
# from google.oauth2 import service_account
#
# # خواندن کلید سرویس از Streamlit Secrets
...
# استفاده از Sidebar برای انتخاب تاریخ و مقیاس
with st.sidebar:
    start_date = st.date_input("تاریخ شروع", value=datetime(2025, 1, 1), min_value=datetime(2000, 1, 1), max_value=datetime.today())
